...
urlpatterns = [
    ...
    path('balanca/', views.ProdutoBalancaExportView.as_view(), name='balanca-export'),
    path('balanca/baixar/itensmgv/', views.ProdutoBalancaDownloadView.as_view(), name='balanca-download'),
    path('gerar-codigo-barras/', views.ProdutoGerarCodigoBarrasView.as_view(), name='produto-gerar-codigo-barras'),
