...
class ResultadoRegraCashback:
    ...
    def gera_cashback(self) -> bool:
        return self.percentual > 0 and self.origem != "desabilitado"
...
def resolver_percentual(*, produto, filial, data: date | None = None) -> ResultadoRegraCashback:
    ...
    if regra_filial is not None and regra_filial.percentual > 0:
        return ResultadoRegraCashback(
    ...
    if regra_empresa is not None and regra_empresa.percentual > 0:
        return ResultadoRegraCashback(
