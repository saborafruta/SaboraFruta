...
from . import (
    ...
    views_orcamentos as vorc, views_estrutura as vest, views_insumos as vins, views_custos as vcus, views_conferencia as vcon, views_op2 as vop2,
...
ROTAS_PRONTAS: list = [
    ...
    path('comercial/envio-pedido/', vap.EnvioProducaoView.as_view(), name='envio-fila'),
    path('comercial/historico/', vh.HistoricoComercialView.as_view(), name='historico-comercial'),
    ...
    path('comercial/pedidos/<int:pk>/arquivos/', vc.PedidoArquivoAddView.as_view(), name='pedido-arquivo-add'),
    path('comercial/pedidos/<int:pk>/arquivos/<int:arquivo_pk>/remover/', vc.PedidoArquivoDeleteView.as_view(), name='pedido-arquivo-delete'),
    ...
    path('engenharia/ficha-tecnica/<int:pk>/peso/grade/', vf.FichaPesoGradeAddView.as_view(), name='ficha-peso-grade-add'),
    path('engenharia/ficha-tecnica/<int:pk>/peso/grade/<int:grade_pk>/remover/', vf.FichaPesoGradeRemoverView.as_view(), name='ficha-peso-grade-remover'),
    path('engenharia/ficha-tecnica/<int:pk>/peso/salvar/', vf.FichaPesoSalvarView.as_view(), name='ficha-peso-salvar'),
