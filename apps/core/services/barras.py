...
MORA NO CORE, e não num vertical. Nasceu na moda, e o segundo vertical que
precisou dele (polpa, para a etiqueta do lote) mostrou o que ele é: um
utilitário de impressão, sem nada de confecção nem de fruta. Deixá-lo lá
faria a polpa importar de dentro da moda -- um acoplamento entre dois
verticais que não têm relação nenhuma.
"""
