...
urlpatterns = [
    ...
    path('gestao/empresas/bancos/<int:pk>/preparando/', admin_area.empresa_banco_progress, name='admin_empresa_banco_progress'),
    path('gestao/empresas/bancos/<int:pk>/status/', admin_area.empresa_banco_status, name='admin_empresa_banco_status'),
    path('gestao/empresas/bancos/<int:pk>/iniciar/', admin_area.empresa_banco_start, name='admin_empresa_banco_start'),
    ...
    path('gestao/filiais/<int:pk>/separar/', admin_area.filial_separar, name='admin_filial_separar'),
    path('gestao/separacoes-filiais/<int:pk>/preparando/', admin_area.filial_separar_progress, name='admin_filial_separar_progress'),
    path('gestao/separacoes-filiais/<int:pk>/status/', admin_area.filial_separar_status, name='admin_filial_separar_status'),
    path('gestao/separacoes-filiais/<int:pk>/iniciar/', admin_area.filial_separar_start, name='admin_filial_separar_start'),
    path('gestao/separacoes-filiais/<int:pk>/download/<str:tipo>/', admin_area.filial_separar_download, name='admin_filial_separar_download'),
