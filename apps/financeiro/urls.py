...
urlpatterns = [
    ...
    path("receber/<int:pk>/editar/",   receber_views.ContaReceberEditView.as_view(),     name="receber_editar"),
    ...
    path("pagar/acoes-lote/",         pagar_views.ContaPagarBulkActionView.as_view(), name="pagar_acoes_lote"),
    ...
    path("condicoes-pagamento/previa/", financeiro.condicoes_pagamento_previa, name="condicoes_pagamento_previa"),
