...
urlpatterns = [
    ...
    path("mdfe/<int:pk>/cancelar/", views.MDFeCancelarRascunhoView.as_view(), name="mdfe-cancelar-rascunho"),
    path("mdfe/<int:pk>/excluir/", views.MDFeDeleteView.as_view(), name="mdfe-delete"),
