...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.core.context_processors.navegacao_context',
...
RAILWAY_CONTROL_PROJECT_TOKEN = env(
    'RAILWAY_CONTROL_PROJECT_TOKEN', default=RAILWAY_PROJECT_TOKEN,
)
...
ORLA_WIDGET_SIGNING_PRIVATE_KEY = env(
    'ORLA_WIDGET_SIGNING_PRIVATE_KEY', default='',
)
...
PRODUTOS_LOOKUP_RATE_LIMIT = env.int('PRODUTOS_LOOKUP_RATE_LIMIT', default=180)
PDV_VENDA_RATE_LIMIT = env.int('PDV_VENDA_RATE_LIMIT', default=30)
...
NFCE_RECONCILIATION_INTERNAL_SCHEDULER = env.bool(
    'NFCE_RECONCILIATION_INTERNAL_SCHEDULER', default=False,
)
